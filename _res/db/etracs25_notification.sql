...
--
-- Host: 192.168.254.131    Database: etracs25_notification
-- ------------------------------------------------------
...
--
-- Dumping data for table `sys_notification_user`
--

LOCK TABLES `sys_notification_user` WRITE;
/*!40000 ALTER TABLE `sys_notification_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_notification_user` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-02-10 11:31:00
